...
const Header = () => {
  return (
    <div className="header-container mb-8 bg-cover  py-6 bg-center h-400px flex flex-col justify-center items-center mb-">
      ...
      <Counter/>
      <p className="text-4xl md:text:4xl md:mt-6 md:top-6 text-center mt-6 md:text-center text-md text-black font-bold font-sans animate-bounce animate-infinite animate-ease-in">
