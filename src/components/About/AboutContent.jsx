    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        <div className="flex flex-col lg:flex-row justify-between gap-8">
            <div className="w-full lg:w-5/12 flex flex-col justify-center">
                <h1 className="text-3xl lg:text-4xl font-bold leading-9 text-gray-800 dark:text-white pb-4">Empowering Remote Work</h1>
                <p className="font-normal text-base leading-6 text-gray-600 dark:text-white">Welcome to LetsRemote, where distance is no longer a barrier to productivity and connectivity.</p>
                <p className="font-normal text-base leading-6 text-gray-600 dark:text-white">At LetsRemote, we believe in the power of technology to bridge gaps and bring people closer together, regardless of where they are in the world. Our mission is to empower individuals, teams, and organizations to thrive in remote environments by providing innovative solutions that simplify communication, collaboration, and workflow management.</p>
            </div>
        ...
        <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
            <div className="w-full lg:w-5/12 flex flex-col justify-center">
                <h1 className="text-3xl lg:text-4xl font-bold leading-9 text-gray-800 dark:text-white pb-4">Commitment to Excellence</h1>
                <p className="font-normal text-base leading-6 text-gray-600 dark:text-white">Our commitment to excellence is reflected in every aspect of our app, from its intuitive user
